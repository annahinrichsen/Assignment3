...
library(tseriesChaos);library(nonlinearTseries);library(SparseM);library(crqa);library(plyr);library(lme4);library(modelr);library(tibble);library(MuMIn);library(stringr)
